...
public class RouteController {
    ...
    @Autowired
    public RouteController( WayPointSelectionService wayPointSelectionService, RouteService routeService, MidpointCalculatorService midpointService, GraphhopperService graphhopperService) {
